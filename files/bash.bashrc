...
export PS1=$IBlack$BICyan\[$BIRed$User$BICyan@$BIBlue$Host$BICyan\]:$Color_Off'$(git branch &>/dev/null;\
	if [ $? -eq 0 ]; then \
    ...
    echo "'$Green'"$(__git_ps1 " (%s)"); \
        ...
        echo "'$IRed'"$(__git_ps1 " {%s}"); \
		  fi) '$BYellow$PathShort$Color_Off$BICyan' $(~/.rvm/bin/rvm-prompt v p g) '$Color_Off'\n$ "; \
	  else \
