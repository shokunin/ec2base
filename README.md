...
1. [Setup - The basics of getting started with ec2base](#setup)
    * [What ec2base affects](#what-ec2base-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with ec2base](#beginning-with-ec2base)
